...
{[}cite\_start{]}Berdasarkan riset yang saya pelajari,
\textbf{Kemiskinan Global} merujuk pada kondisi di mana individu
kekurangan kebutuhan dasar seperti makanan, air bersih, perumahan,
pendidikan, dan layanan kesehatan{[}cite: 182{]}.

{[}cite\_start{]}Secara teknis, Bank Dunia mendefinisikan
\textbf{kemiskinan ekstrem} sebagai kondisi bertahan hidup dengan
pendapatan di bawah \textbf{USD 2,15 per hari}{[}cite: 183{]}. Ini
adalah ambang batas yang membuat seseorang sulit memenuhi standar hidup
minimum.
...
\tightlist
\item
  {[}cite\_start{]}\textbf{Populasi Terdampak:} Sekitar \textbf{700 juta
  orang} (8,5\% populasi dunia) saat ini hidup dalam kemiskinan
  ekstrem{[}cite: 185{]}.
\item
  {[}cite\_start{]}\textbf{Lokasi:} Mayoritas terkonsentrasi di negara
  berpenghasilan rendah, khususnya di \textbf{Sub-Sahara Afrika}{[}cite:
  186{]}.
\item
  {[}cite\_start{]}\textbf{Tren:} Penurunan kemiskinan sempat mengalami
  kemunduran akibat pandemi COVID-19 dan krisis ekonomi global{[}cite:
  188{]}.
\end{itemize}
...
\item
  {[}cite\_start{]}\textbf{Dampak Fisik:} Hal ini menyebabkan malnutrisi
  dan kesehatan yang buruk.
\item
  {[}cite\_start{]}\textbf{Dampak Edukasi:} Tingkat pendidikan menjadi
  rendah karena biaya atau kondisi fisik yang lemah.
\item
  {[}cite\_start{]}\textbf{Dampak Ekonomi Lanjutan:} Terbatasnya
  kesempatan ekonomi (karena kurang pendidikan/kesehatan), yang akhirnya
  memperkuat kembali kemiskinan itu sendiri.
\end{enumerate}

\section{4. Refleksi Pribadi}\label{refleksi-pribadi}

{[}Tuliskan sedikit pemikiranmu di sini. Contoh: ``Sebagai mahasiswa,
saya melihat bahwa solusi kemiskinan tidak bisa hanya dengan bantuan
tunai, tetapi harus memutus rantai di sektor pendidikan dan
kesehatan.''{]}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\textbf{Referensi Materi:} * \emph{Laporan Global Poverty \& SDG 1 PBB}

\url{https://youtu.be/kl39KHS07Xc}
